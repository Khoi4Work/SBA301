...
export function Sidebar() {
    ...
    return (
        <nav
            className="hidden md:flex flex-col h-screen py-8 bg-surface-container-low border-r border-outline-variant/10 fixed left-0 top-0 w-64 z-50">
                            ...
                            {sessions.length === 0 ? (
                                ...
                                sessions.map(session => (
                                    <div
                                        ...
                                        className={`group flex items-center justify-between px-4 py-2 rounded-lg cursor-pointer transition-all duration-200 ${currentSessionId === session.sessionId
