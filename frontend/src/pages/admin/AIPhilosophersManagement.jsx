      ...
      {/* Bento Grid of Philosophers */}
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {philosophers.map((philosopher) => (
                ...
                <span className="bg-secondary/10 text-secondary px-3 py-0.5 text-[10px] font-semibold uppercase tracking-wider border border-secondary/20">
    ...
    <span className="text-on-surface-variant opacity-60 uppercase shrink-0">
        ...
        {philosopher.core || "-"}
            ...
            {!loading && philosophers.length === 0 && (
                <div className="folio-card p-8 bg-surface-container-low border border-secondary/10 text-on-surface-variant min-h-[300px] flex items-center justify-center text-center">
              ...
              {philosophers.map((philosopher) => (
                  ...
                  >
                      <td className="py-6 px-6 flex items-center gap-4">
                          <div className="w-10 h-10 bg-surface-container-high border border-secondary/20 flex items-center justify-center group-hover:border-secondary/50 overflow-hidden">
                              {philosopher.imageUrl ? (
                                  <img
                          ...
                          <span className="font-display text-2xl font-semibold text-on-surface group-hover:text-secondary transition-colors">
                    {philosopher.name || "Unknown"}
                </span>
                      </td>
